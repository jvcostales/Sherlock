...
def main():
    if current_user.is_authenticated:
        ...
        if last_7_days:
            expenses, total_expenses, total_amount = load_expenses_last_7_days(page)
            total_amount_all_pages = compute_total_amount_all_pages(load_expenses_last_7_days, total_expenses)
        elif last_28_days:
            expenses, total_expenses, total_amount = load_expenses_last_28_days(page)
        ...
        return render_template('index.html', expenses=expenses, page=page, total_expenses=total_expenses, total_amount=total_amount_all_pages, last_7_days=last_7_days, last_28_days=last_28_days)
    else:
        return redirect(url_for('login'))
...
def compute_total_amount_all_pages(load_expenses_func, total_pages):
    ...
    for page in range(1, total_pages + 1):
        _, _, total_amount = load_expenses_func(page)
